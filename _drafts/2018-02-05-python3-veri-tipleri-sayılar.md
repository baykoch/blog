...
Mantıksal veri tipleridir. Önermeleri ve mantık durumlarını kontrol etmek için kullanılır. `True` ve `False`  olmak üzere 2 değerine  sahiptir. Aslında burda `True` 1 değerine `False`  0 değerine  eşittir.
